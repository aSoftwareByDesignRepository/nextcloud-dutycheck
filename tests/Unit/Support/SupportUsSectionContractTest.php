...
final class SupportUsSectionContractTest extends TestCase {
	...
	public function testCssContractHasFocusAndReducedMotion(): void {
		...
		if (is_file($dedicated)) {
			...
			self::assertStringContainsString('#app-content.dc-app--admin-support-us ul.dc-support-us-page__trust', $pageCss);
			...
			self::assertMatchesRegularExpression(
				'/\.dc-support-us--page \.dc-support-us__primary\s*\{[^}]*max-width:\s*none/s',
				$pageCss,
