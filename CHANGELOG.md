...
- **Conflict rematerialize:** After threshold save/apply, budget-dirty open periods rematerialize so stale hard caps do not linger; concurrent sibling writers get clear already-decided handling where applicable.

## 0.3.3 - 2026-09-17

### Changed

- App Store / GitHub release cut from the conflict-threshold source on `master` (correct `v0.3.3` tag); packaging and App Store signature refreshed for upload.
