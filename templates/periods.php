...
<section class="dc-card dc-section" aria-labelledby="dc-snapshot-title">
	...
	<div class="dc-table-wrap" tabindex="0" role="region" aria-labelledby="dc-snapshot-title">
		<table class="dc-table" aria-busy="true">
			...
			<tbody id="dc-snapshots-table-body">
				<tr class="dc-table__loading-row">
					<td class="dc-loading" colspan="4"><?php p($l->t('Loading…')); ?></td>
				</tr>
			</tbody>
		</table>
	</div>
...
<section class="dc-card dc-section" aria-labelledby="dc-audit-title">
	...
	<div class="dc-table-wrap" tabindex="0" role="region" aria-labelledby="dc-audit-title">
		<table class="dc-table" aria-busy="true">
			...
			<tbody id="dc-period-audit-table-body">
				<tr class="dc-table__loading-row">
					<td class="dc-loading" colspan="4"><?php p($l->t('Loading…')); ?></td>
				</tr>
			</tbody>
