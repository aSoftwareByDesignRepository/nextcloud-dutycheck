...
namespace OCA\DutyCheck\License;

use OCA\DutyCheck\Config\VendorPublicKey;

/**
 * DTY2 wire format (SPEC §8.1): `DTY2.<payload_b64url>.<signature_b64url>`,
 ...
 */
final class Dty2Codec
{
	public const FORMAT = 'DTY2';
	public const VERSION = 2;
	public const PRODUCT = 'dutycheck';
	...
	public static function canonicalJson(array $payload): string
	{
		...
		if ($json === false) {
			throw new \RuntimeException('DTY2 canonical JSON encode failed.');
		}
		return $json;
	}
