...
final class ApiJsonErrorResponse
{
	...
	public static function statusForInvalidArgument(string $errorCode): int
	{
		return match ($errorCode) {
			...
			'PERIOD_STATUS_CONFLICT', 'ABSENCE_STATUS_CONFLICT', 'STALE_VERSION', 'ASSIGNMENT_TRANSFER_STALE', 'CONFLICT_ACK_STALE' => 409,
			'EXPECTED_VERSION_REQUIRED' => 422,
			'FORBIDDEN', 'COMPANY_MISMATCH', 'COMPANY_MEMBERSHIP_REQUIRED' => 403,
