...
final class ApiJsonErrorResponse
{
	...
	public static function statusForInvalidArgument(string $errorCode): int
	{
		return match ($errorCode) {
			...
			'PERIOD_NOT_FOUND', 'ABSENCE_NOT_FOUND', 'EMPLOYEE_LINK_NOT_FOUND', 'CONFLICT_NOT_FOUND', 'EMPLOYEE_NOT_FOUND' => 404,
			'SNAPSHOT_HASH_MISMATCH' => 500,
			'PERIOD_NOT_OPEN', 'ASSIGNMENT_OVERLAP', 'ASSIGNMENT_DUPLICATE_SLOT', 'ABSENCE_CONFLICT', 'PERIOD_HAS_HARD_CONFLICTS', 'ABSENCE_OVERLAP', 'EQUAL_DUTY_TIMES', 'INVALID_SHIFT_LENGTH', 'DATE_OUTSIDE_PERIOD' => 422,
