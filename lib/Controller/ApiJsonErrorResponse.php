...
final class ApiJsonErrorResponse
{
	...
	public static function statusForInvalidArgument(string $errorCode): int
	{
		return match ($errorCode) {
			...
			'PERIOD_NOT_FOUND', 'ABSENCE_NOT_FOUND', 'EMPLOYEE_LINK_NOT_FOUND', 'CONFLICT_NOT_FOUND', 'EMPLOYEE_NOT_FOUND', 'ASSIGNMENT_NOT_FOUND', 'TEMPLATE_NOT_FOUND', 'SWAP_NOT_FOUND', 'OPEN_SHIFT_NOT_FOUND', 'PATTERN_NOT_FOUND', 'PREFERENCE_NOT_FOUND', 'BLACKOUT_NOT_FOUND', 'COMPANY_NOT_FOUND', 'LOCATION_NOT_FOUND' => 404,
			'SNAPSHOT_HASH_MISMATCH' => 500,
			'PERIOD_NOT_OPEN', 'PERIOD_NOT_PUBLISHED', 'ASSIGNMENT_CANCELLED', 'ASSIGNMENT_OVERLAP', 'SWAP_CONFLICT', 'SWAP_ALREADY_PENDING', 'OPEN_SHIFT_CONFLICT', 'OPEN_SHIFT_NOT_OPEN', 'ASSIGNMENT_DUPLICATE_SLOT', 'ABSENCE_CONFLICT', 'PERIOD_HAS_HARD_CONFLICTS', 'ABSENCE_OVERLAP', 'EQUAL_DUTY_TIMES', 'INVALID_SHIFT_LENGTH', 'DATE_OUTSIDE_PERIOD', 'QUALIFICATION_MISSING', 'QUALIFICATION_NAME_INVALID', 'QUALIFICATION_NAME_EXISTS', 'QUALIFICATION_NOT_FOUND', 'EMPLOYEE_QUALIFICATION_NOT_FOUND', 'INVALID_EXPIRY_DATE', 'INVALID_CONFLICT_POLICY', 'TEMPLATE_NAME_INVALID',
			'CYCLE_WEEKS_UNSUPPORTED', 'PATTERN_NAME_CONFLICT', 'PATTERN_NAME_INVALID', 'PATTERN_INACTIVE', 'SUGGEST_PERIOD_NOT_OPEN', 'SUGGEST_LOCATION_REQUIRED', 'PEER_VISIBILITY_DISABLED', 'PREFERENCE_CONFLICT', 'PREFERENCES_DISABLED', 'PREFERENCE_BAND_INVALID', 'PREFERENCE_MASK_INVALID', 'PREFERENCE_DATE_RANGE_INVALID', 'BLACKOUT_OVERLAP', 'BLACKOUT_PAST_READONLY', 'SWAP_ABSENCE_CONFLICT', 'SWAP_QUALIFICATION', 'SWAP_CROSS_LOCATION_FORBIDDEN', 'SWAP_NO_COUNTERPARTY', 'SWAP_SAME_EMPLOYEE', 'BLACKOUTS_DISABLED', 'BLACKOUT_CONFLICT', 'BLACKOUT_LABEL_INVALID', 'BLACKOUT_RANGE_INVALID', 'BLACKOUT_SPAN_EXCEEDED', 'BLACKOUT_HORIZON_EXCEEDED', 'BLACKOUT_DATETIME_INVALID', 'BLACKOUT_DATE_INVALID', 'ROTATION_DISABLED', 'INVALID_ANCHOR_DATE', 'TODAY_BOARD_DISABLED', 'INVALID_TEAM_WEEK_QUERY', 'WEEK_START_INVALID', 'INVALID_VALID_TO', 'INVALID_DATE_RANGE', 'PREFERENCE_DATE_INVALID', 'DATE_INVALID', 'REASON_TOO_LONG' => 422,
